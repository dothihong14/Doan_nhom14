<div>
    ...
    <head>
        ...
        <script>
            window._wpemojiSettings = {
                ...
                "svgExt": ".svg",
                "source": {"concatemoji": "https:\/\/demo2.themelexus.com\/delicioz\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.0.2"}
            };
                            ...
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <div
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="delicioz-woocommerce-title" style="font-family: 'Times New Roman'">Đặt hàng</div>
                                        <nav class="woocommerce-breadcrumb"><a href="/">Trang chủ</a><i
                                                class="delicioz-icon-arrow-right-s-line"></i>Đặt hàng
                                        </nav>
                                    </div>
                                </div>
                            </div>
    ...
    <script
        ...
        {"@context":"https:\/\/schema.org\/","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"name":"Home Page","@id":"https:\/\/demo2.themelexus.com\/delicioz"}},{"@type":"ListItem","position":2,"item":{"name":"Checkout","@id":"https:\/\/demo2.themelexus.com\/delicioz\/checkout\/"}}]}
    </script>
    ...
    <script id='wc-checkout-js-extra'>
        var wc_checkout_params = {
            "ajax_url": "\/delicioz\/wp-admin\/admin-ajax.php",
            "wc_ajax_url": "\/delicioz\/?wc-ajax=%%endpoint%%",
            "update_order_review_nonce": "1f878d4100",
            "apply_coupon_nonce": "1184aae44f",
            "remove_coupon_nonce": "6cb0e73d5e",
            "option_guest_checkout": "yes",
            "checkout_url": "\/delicioz\/?wc-ajax=checkout",
            "is_checkout": "1",
            "debug_mode": "",
    ...
    <script id='elementor-frontend-js-before'>
        var elementorFrontendConfig = {
            ...
            "urls": {"assets": "https:\/\/demo2.themelexus.com\/delicioz\/wp-content\/plugins\/elementor\/assets\/"},
            ...
            "post": {"id": 11, "title": "Checkout%20%E2%80%93%20Delicioz", "excerpt": "", "featuredImage": false},
            "user": {"roles": ["customer"]}
        };
    </script>
